...
import com.example.free_image_part4_chapter07.data.models.PhotoResponse
...
class MainActivity : AppCompatActivity() {
                        ...
                        if (wallpaperManager.isWallpaperSupported
                            ...
                            snackbar.setAction("배경 화면으로 지정") {
                                try {
                                    ...
                                    Snackbar.make(binding.root, "배경 화면 지정 실패", Snackbar.LENGTH_SHORT).show()
                                }
                            }
    ...
    private fun saveBitmapToMediaStore(bitmap: Bitmap) {
        ...
        // kotlin에서 제공하는 use 블럭 사용 시, Stream을 닫아주는 동작까지 해줌
